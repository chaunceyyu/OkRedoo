 ...
 */
@MessageTag(value = MsgType.BAR_RAGE_MSG, flag = MessageTag.NONE)
public class BarrageMsg extends MessageContent {
    ...
    public static final Creator<BarrageMsg> CREATOR = new Creator() {
    ...
    protected BarrageMsg() {
    }

    public static BarrageMsg obtain(String text) {
        BarrageMsg model = new BarrageMsg();
        model.setContent(text);
        return model;
    }

    public BarrageMsg(byte[] data) {
        String jsonStr = null;
    ...
    public BarrageMsg(String content) {
