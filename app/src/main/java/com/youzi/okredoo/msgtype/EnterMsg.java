 ...
 */
@MessageTag(value = MsgType.LIVE_ENTER, flag = MessageTag.NONE)
public class EnterMsg extends MessageContent {
    ...
    public static final Creator<EnterMsg> CREATOR = new Creator() {
        public EnterMsg createFromParcel(Parcel source) {
            return new EnterMsg(source);
        }

        public EnterMsg[] newArray(int size) {
            return new EnterMsg[size];
        }
    };
    ...
    public static EnterMsg obtain(String text) {
        EnterMsg model = new EnterMsg();
        model.setContent(text);
        return model;
    }

    public EnterMsg(byte[] data) {
        String jsonStr = null;
    ...
    public EnterMsg(String content) {
