 ...
 */
@MessageTag(value = MsgType.GIFT_MSG, flag = MessageTag.ISCOUNTED | MessageTag.ISPERSISTED)
public class GiftMsg extends MessageContent {
    ...
    public static final Creator<GiftMsg> CREATOR = new Creator() {
    ...
    public static GiftMsg obtain(String text) {
        GiftMsg model = new GiftMsg();
        model.setContent(text);
        return model;
    }

    public static GiftMsg obtain_private(String chatMsg, String count, String icon, String price) {
        GiftMsg model = new GiftMsg();
        model.setChatMsg(chatMsg);
