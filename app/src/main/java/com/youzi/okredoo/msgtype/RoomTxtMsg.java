 ...
 */
@MessageTag(value = "RC:RoomTxt", flag = MessageTag.NONE)
public class RoomTxtMsg extends MessageContent {
    ...
    protected String extra;     //用于区分性别，1男 else女
    public static final Creator<RoomTxtMsg> CREATOR = new Creator() {
        public RoomTxtMsg createFromParcel(Parcel source) {
            return new RoomTxtMsg(source);
        }

        public RoomTxtMsg[] newArray(int size) {
            return new RoomTxtMsg[size];
        }
    };
    ...
    protected RoomTxtMsg() {
    }

    public static RoomTxtMsg obtain(String text, String uid, String photo, String name, String grade, String role) {
        RoomTxtMsg model = new RoomTxtMsg();
    ...
    public RoomTxtMsg(String content) {
