 ...
 */
@MessageTag(value = MsgType.TOBUG_MSG, flag = MessageTag.NONE)
public class ToBuyMsg extends MessageContent {
    ...
    public static final Creator<ToBuyMsg> CREATOR = new Creator() {
        public ToBuyMsg createFromParcel(Parcel source) {
            return new ToBuyMsg(source);
        }

        public ToBuyMsg[] newArray(int size) {
            return new ToBuyMsg[size];
        }
    };
    ...
    public static ToBuyMsg obtain(String text) {
        ToBuyMsg model = new ToBuyMsg();
        model.setContent(text);
        return model;
    }

    public ToBuyMsg(byte[] data) {
        String jsonStr = null;
    ...
    public ToBuyMsg(String content) {
