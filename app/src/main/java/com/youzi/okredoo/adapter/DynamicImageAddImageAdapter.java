...
public class DynamicImageAddImageAdapter extends
        RecyclerView.Adapter<DynamicImageAddImageAdapter.ViewHolder> {
    ...
    public DynamicImageAddImageAdapter(Context context, onAddPicClickListener mOnAddPicClickListener) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = mInflater.inflate(R.layout.dynamic_image_add_image_item,
                viewGroup, false);
            ...
            switch (type) {
                case 1:
                    ...
                    if (media.isCompressed()) {
                        LogUtil.i("compress image result", new File(media.getCompressPath()).length() / 1024 + "k");
                    }
